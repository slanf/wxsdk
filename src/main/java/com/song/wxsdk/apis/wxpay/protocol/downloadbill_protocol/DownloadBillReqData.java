package com.song.wxsdk.apis.wxpay.protocol.downloadbill_protocol;


import com.song.wxsdk.apis.wxpay.config.Configure;
import com.song.wxsdk.utils.WxpayUtil;
...
public class DownloadBillReqData {
    ...
    public DownloadBillReqData(String deviceInfo,String billDate,String billType){
        ...
        //随机字符串，不长于32 位
        setNonce_str(WxpayUtil.getRandomStringByLength(32));

        //根据API给的签名规则进行签名
        String sign = WxpayUtil.getSign(toMap(),Configure.getKey());
